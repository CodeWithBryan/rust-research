...
{
	// Token: 0x060036BD RID: 14013 RVA: 0x001459B0 File Offset: 0x00143BB0
	...
	// Token: 0x060036BE RID: 14014 RVA: 0x00145E54 File Offset: 0x00144054
	...
	// Token: 0x060036BF RID: 14015 RVA: 0x00145E89 File Offset: 0x00144089
	...
	// Token: 0x060036C0 RID: 14016 RVA: 0x00145EC2 File Offset: 0x001440C2
	...
	// Token: 0x060036C1 RID: 14017 RVA: 0x00145EF8 File Offset: 0x001440F8
	public static void GenerateVectors(in int size, in float[] distanceField, ref Vector3[] vectorField)
	{
		for (int i = 1; i < size - 1; i++)
		{
			...
			{
				float z = DistanceField.SampleClamped(distanceField, size, i, j);
				float num = DistanceField.SampleClamped(distanceField, size, i - 1, j - 1);
				float num2 = DistanceField.SampleClamped(distanceField, size, i - 1, j);
				float num3 = DistanceField.SampleClamped(distanceField, size, i - 1, j + 1);
				float num4 = DistanceField.SampleClamped(distanceField, size, i, j - 1);
				float num5 = DistanceField.SampleClamped(distanceField, size, i, j + 1);
				float num6 = DistanceField.SampleClamped(distanceField, size, i + 1, j - 1);
				float num7 = DistanceField.SampleClamped(distanceField, size, i + 1, j);
				float num8 = DistanceField.SampleClamped(distanceField, size, i + 1, j + 1);
				float num9 = num6 + 2f * num7 + num8 - (num + 2f * num2 + num3);
				float num10 = num3 + 2f * num5 + num8 - (num + 2f * num4 + num6);
				Vector2 normalized = new Vector2(-num9, -num10).normalized;
	...
	// Token: 0x060036C2 RID: 14018 RVA: 0x001460BC File Offset: 0x001442BC
	...
	private static readonly int[] GaussOffsets = new int[]
	{
		-6,
		-4,
		-2,
