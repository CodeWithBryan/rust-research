...
{
	// Token: 0x06003921 RID: 14625 RVA: 0x0015173C File Offset: 0x0014F93C
	...
	// Token: 0x06003922 RID: 14626 RVA: 0x001517DC File Offset: 0x0014F9DC
	...
	// Token: 0x06003923 RID: 14627 RVA: 0x00151844 File Offset: 0x0014FA44
	...
	// Token: 0x06003924 RID: 14628 RVA: 0x00151908 File Offset: 0x0014FB08
	...
	// Token: 0x06003925 RID: 14629 RVA: 0x00151984 File Offset: 0x0014FB84
	...
	// Token: 0x06003926 RID: 14630 RVA: 0x00151AD0 File Offset: 0x0014FCD0
	...
	// Token: 0x06003927 RID: 14631 RVA: 0x00151BE8 File Offset: 0x0014FDE8
	...
	// Token: 0x06003928 RID: 14632 RVA: 0x00151CD4 File Offset: 0x0014FED4
	private static Vector4[] calculateMeshTangents(int[] triangles, Vector3[] vertices, Vector2[] uv, Vector3[] normals)
	{
		...
		for (long num3 = 0L; num3 < (long)num; num3 += 3L)
		{
			...
			Vector3 b = new Vector3((num16 * num7 - num15 * num8) * num18, (num16 * num9 - num15 * num10) * num18, (num16 * num11 - num15 * num12) * num18);
			Vector3 b2 = new Vector3((num13 * num8 - num14 * num7) * num18, (num13 * num10 - num14 * num9) * num18, (num13 * num12 - num14 * num11) * num18);
			checked
			{
		...
		for (long num19 = 0L; num19 < (long)num2; num19 += 1L)
		{
			checked
			{
				Vector3 lhs = normals[(int)((IntPtr)num19)];
				Vector3 vector7 = array[(int)((IntPtr)num19)];
				Vector3.OrthoNormalize(ref lhs, ref vector7);
				array3[(int)((IntPtr)num19)].x = vector7.x;
				array3[(int)((IntPtr)num19)].y = vector7.y;
				array3[(int)((IntPtr)num19)].z = vector7.z;
				array3[(int)((IntPtr)num19)].w = ((Vector3.Dot(Vector3.Cross(lhs, vector7), array2[(int)((IntPtr)num19)]) < 0f) ? -1f : 1f);
			}
		}
		return array3;
	}

	// Token: 0x06003929 RID: 14633 RVA: 0x00151FFC File Offset: 0x001501FC
