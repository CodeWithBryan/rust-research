...
public class ConsoleGen
{
	...
	public static ConsoleSystem.Command[] All = new ConsoleSystem.Command[]
	{
		new ConsoleSystem.Command
		{
			...
			{
				AIBrainSenses.HumanKnownPlayersLOSUpdateInterval = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AIBrainSenses.KnownPlayersLOSUpdateInterval = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AIBrainSenses.UpdateInterval = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AIThinkManager.animalframebudgetms = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AIThinkManager.framebudgetms = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AIThinkManager.petframebudgetms = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BaseFirework.maxActiveFireworks = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BaseNavigator.baseNavMovementFrameInterval = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BaseNavigator.maxStepUpDistance = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BaseNavigator.navTypeDistance = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BaseNavigator.navTypeHeightOffset = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BaseNavigator.stuckTriggerDuration = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BasePet.movementupdatebudgetms = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BasePlayer.lifeStoryFramebudgetms = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BaseRidableAnimal.decayminutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BaseRidableAnimal.dungTimeScale = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BaseRidableAnimal.framebudgetms = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BaseSubmarine.deepwaterdecayminutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BaseSubmarine.outsidedecayminutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BaseSubmarine.oxygenminutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Bear.Population = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BigWheelGame.spinFrequencySeconds = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BlackjackMachine.maxbet = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Boar.Population = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				BoomBox.BacktrackLength = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CargoShip.egress_duration_minutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CargoShip.event_duration_minutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CargoShip.loot_round_spacing_minutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CargoShip.loot_rounds = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Cassette.MaxCassetteFileSizeMB = str.ToFloat(0f);
			},
			Default = "5"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Chicken.Population = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ClothLOD.clothLODDist = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CodeLock.lockoutCooldown = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CodeLock.maxFailedAttempts = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.nav_carve_height = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.nav_carve_min_base_size = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.nav_carve_min_building_blocks_to_apply_optimization = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.nav_carve_size_multiplier = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_alertness_drain_rate = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_alertness_to_aim_modifier = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_alertness_zero_detection_mod = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_cover_compromised_cooldown = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_cover_info_tick_rate_multiplier = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_cover_path_vs_straight_dist_max_diff = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_deliberate_hit_randomizer = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_deliberate_miss_offset_multiplier = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_deliberate_miss_to_hit_alignment_time = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_door_trigger_size = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_gun_noise_silencer_modifier = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_htn_player_base_damage_modifier = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_htn_player_frustration_threshold = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_junkpile_a_spawn_chance = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_junkpile_dist_aggro_gate = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_junkpile_g_spawn_chance = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_junkpilespawn_chance = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_max_junkpile_count = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_max_population_military_tunnels = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_max_roam_multiplier = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_patrol_point_cooldown = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_reasoning_system_tick_rate_multiplier = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_respawn_delay_max_military_tunnels = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_respawn_delay_min_military_tunnels = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_sensory_system_tick_rate_multiplier = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_spawn_per_tick_max_military_tunnels = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_spawn_per_tick_min_military_tunnels = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_speed_crouch_run = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_speed_crouch_walk = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_speed_run = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_speed_sprint = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_speed_walk = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_valid_aim_cone = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.npc_valid_mounted_aim_cone = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AI.ocean_patrol_path_iterations = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.build_inside_check = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.build_losradius = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.build_losradius_sleepingbag = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.debuglevel = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.enforcementlevel = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.eye_clientframes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.eye_forgiveness = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.eye_history_forgiveness = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.eye_history_penalty = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.eye_losradius = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.eye_noclip_backtracking = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.eye_noclip_cutoff = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.eye_noclip_margin = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.eye_penalty = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.eye_protection = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.eye_serverframes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.flyhack_extrusion = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.flyhack_forgiveness_horizontal = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.flyhack_forgiveness_horizontal_inertia = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.flyhack_forgiveness_vertical = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.flyhack_forgiveness_vertical_inertia = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.flyhack_margin = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.flyhack_maxsteps = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.flyhack_penalty = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.flyhack_protection = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.flyhack_stepsize = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.maxdeltatime = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.maxdesync = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.maxviolation = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.melee_clientframes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.melee_forgiveness = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.melee_losforgiveness = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.melee_penalty = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.melee_protection = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.melee_serverframes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.noclip_backtracking = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.noclip_margin = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.noclip_margin_dismount = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.noclip_maxsteps = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.noclip_penalty = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.noclip_protection = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.noclip_stepsize = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.projectile_anglechange = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.projectile_backtracking = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.projectile_clientframes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.projectile_damagedepth = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.projectile_desync = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.projectile_forgiveness = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.projectile_impactspawndepth = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.projectile_losforgiveness = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.projectile_penalty = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.projectile_protection = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.projectile_serverframes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.projectile_trajectory = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.projectile_velocitychange = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.relaxationpause = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.relaxationrate = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.speedhack_forgiveness = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.speedhack_forgiveness_inertia = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.speedhack_penalty = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.speedhack_protection = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.speedhack_slopespeed = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.terrain_padding = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.terrain_penalty = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.terrain_protection = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.terrain_timeslice = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.tickhistoryforgiveness = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.tickhistorytime = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.AntiHack.userlevel = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				App.alarmcooldown = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				App.maxconnections = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				App.maxconnectionsperip = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Bradley.respawnDelayMinutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Bradley.respawnDelayVariance = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Chat.localChatRange = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				IEnumerable<Output.Entry> rval = ConVar.Console.search(arg);
				arg.ReplyWithObject(rval);
			}
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Construct.frameminutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.bracket_0_blockcount = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.bracket_0_costfraction = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.bracket_1_blockcount = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.bracket_1_costfraction = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.bracket_2_blockcount = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.bracket_2_costfraction = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.bracket_3_blockcount = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.bracket_3_costfraction = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.delay_metal = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.delay_override = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.delay_stone = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.delay_toptier = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.delay_twig = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.delay_wood = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.duration_metal = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.duration_override = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.duration_stone = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.duration_toptier = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.duration_twig = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.duration_wood = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.outside_test_range = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.scale = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.tick = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.upkeep_grief_protection = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.upkeep_heal_scale = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.upkeep_inside_decay_scale = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Decay.upkeep_period_minutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Demo.recordlistmode = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Demo.splitmegabytes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Demo.splitseconds = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval = Entity.svspawn(arg.GetString(0, ""), arg.GetVector3(1, Vector3.zero), arg.GetVector3(2, Vector3.zero));
				arg.ReplyWithObject(rval);
			}
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.GC.incremental_enabled = str.ToBool();
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.GC.incremental_milliseconds = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Global.MaxSpraysPerPlayer = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Global.preloadConcurrency = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Global.SprayDuration = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Global.SprayOutOfAuthMultiplier = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Global.warmupConcurrency = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Halloween.murdererpopulation = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Halloween.scarecrow_beancan_vs_player_dmg_modifier = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Halloween.scarecrow_body_dmg_modifier = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Halloween.scarecrow_chase_stopping_distance = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Halloween.scarecrow_throw_beancan_global_delay = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Halloween.scarecrowpopulation = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Net.visibilityRadiusFarOverride = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Net.visibilityRadiusNearOverride = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				PatrolHelicopter.bulletAccuracy = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				PatrolHelicopter.bulletDamageScale = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				PatrolHelicopter.guns = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				PatrolHelicopter.lifetimeMinutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Physics.bouncethreshold = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Physics.droppedmode = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Physics.gravity = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Physics.groundwatchdelay = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Physics.groundwatchfails = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Physics.minsteps = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Physics.sleepthreshold = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Physics.solveriterationcount = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Physics.steps = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Player.tickrate_cl = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Player.tickrate_sv = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Sentry.hostileduration = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.anticheatlog = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.arrowarmor = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.arrowdamage = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.artificialTemperatureGrowableRange = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.authtimeout = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.bansServerFailureMode = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.bansServerTimeout = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.bleedingarmor = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.bleedingdamage = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.bulletarmor = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.bulletdamage = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.ceilingLightGrowableRange = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.ceilingLightHeightOffset = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval = Server.combatlog(arg);
				arg.ReplyWithObject(rval);
			}
		},
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval = Server.combatlog_outgoing(arg);
				arg.ReplyWithObject(rval);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.combatlogdelay = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.combatlogsize = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.composterUpdateInterval = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.conveyorMoveFrequency = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.corpsedespawn = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.crawlingmaximumhealth = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.crawlingminimumhealth = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.cycletime = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.debrisdespawn = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.defaultBlueprintResearchCost = str.ToInt(0);
			},
			Default = "10"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.entitybatchsize = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.entitybatchtime = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.funWaterDamageThreshold = str.ToFloat(0f);
			},
			Default = "0.8"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.funWaterWetnessGain = str.ToFloat(0f);
			},
			Default = "0.05"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.idlekickadmins = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.idlekickmode = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.incapacitatedrecoverchance = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.industrialCrafterFrequency = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.ipQueriesPerMin = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.itemdespawn = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.itemdespawn_container_scale = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.itemdespawn_quick = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.maxconnectionsperip = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.maxdecryptqueue = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.maxItemStacksMovedPerTickIndustrial = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.maxpacketsize = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.maxpacketsize_command = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.maxpacketspersecond = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.maxpacketspersecond_command = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.maxpacketspersecond_rpc = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.maxpacketspersecond_rpc_signal = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.maxpacketspersecond_tick = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.maxpacketspersecond_voice = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.maxpacketspersecond_world = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.maxreadqueue = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.maxreceivetime = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.maxwritequeue = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.meleearmor = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.meleedamage = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.metabolismtick = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.modifierTickRate = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.netcachesize = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval = Server.netprotocol(arg);
				arg.ReplyWithObject(rval);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.nonPlanterDeathChancePerTick = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.optimalPlanterQualitySaturation = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval = Server.packetlog(arg);
				arg.ReplyWithObject(rval);
			}
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.planttick = str.ToFloat(0f);
			},
			Default = "60"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.planttickscale = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.playertimeout = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval = Server.printeyes(arg);
				arg.ReplyWithObject(rval);
			}
		},
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval = Server.printpos(arg);
				arg.ReplyWithObject(rval);
			}
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval = Server.printrot(arg);
				arg.ReplyWithObject(rval);
			}
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.queriesPerSecond = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			Call = delegate(ConsoleSystem.Arg arg)
			{
				string rval = Server.readcfg(arg);
				arg.ReplyWithObject(rval);
			}
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.respawnresetrange = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.rewounddelay = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.saveBackupCount = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.savecachesize = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.saveinterval = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.schematime = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.sprinklerEyeHeightOffset = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.sprinklerRadius = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.updatebatch = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.updatebatchspawn = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.woundedmaxfoodandwaterbonus = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Server.woundedrecoverchance = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Spawn.max_density = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Spawn.min_density = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Spawn.player_base = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Spawn.player_scale = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Spawn.tick_individuals = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Spawn.tick_populations = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Stability.accuracy = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Stability.collapse = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Stability.stabilityqueue = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Stability.surroundingsqueue = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Time.fixeddelta = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Time.maxdelta = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ConVar.Time.timescale = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				vehicle.boat_corpse_seconds = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.atmosphere_brightness = str.ToFloat(0f);
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.atmosphere_contrast = str.ToFloat(0f);
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.atmosphere_directionality = str.ToFloat(0f);
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.atmosphere_mie = str.ToFloat(0f);
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.atmosphere_rayleigh = str.ToFloat(0f);
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.clear_chance = str.ToFloat(0f);
			},
			Default = "1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.cloud_attenuation = str.ToFloat(0f);
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.cloud_brightness = str.ToFloat(0f);
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.cloud_coloring = str.ToFloat(0f);
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.cloud_coverage = str.ToFloat(0f);
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.cloud_opacity = str.ToFloat(0f);
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.cloud_saturation = str.ToFloat(0f);
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.cloud_scattering = str.ToFloat(0f);
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.cloud_sharpness = str.ToFloat(0f);
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.cloud_size = str.ToFloat(0f);
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.dust_chance = str.ToFloat(0f);
			},
			Default = "0"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.fog_chance = str.ToFloat(0f);
			},
			Default = "0"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.overcast_chance = str.ToFloat(0f);
			},
			Default = "0"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.rain_chance = str.ToFloat(0f);
			},
			Default = "0"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.rainbow = str.ToFloat(0f);
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.storm_chance = str.ToFloat(0f);
			},
			Default = "0"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.thunder = str.ToFloat(0f);
			},
			Default = "-1"
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.wetness_rain = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Weather.wetness_snow = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				XMas.giftsPerPlayer = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				XMas.spawnAttempts = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				XMas.spawnRange = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ExcavatorSignalComputer.chargeNeededForSupplies = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SteamNetworking.steamconnectiontimeout = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SteamNetworking.steamnagletime = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SteamNetworking.steamnetdebug = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SteamNetworking.steamnetdebug_ackrtt = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SteamNetworking.steamnetdebug_message = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SteamNetworking.steamnetdebug_p2prendezvous = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SteamNetworking.steamnetdebug_packetdecode = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SteamNetworking.steamnetdebug_packetgaps = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SteamNetworking.steamnetdebug_sdrrelaypings = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SteamNetworking.steamsendbuffer = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SteamNetworking.steamsendratemax = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SteamNetworking.steamsendratemin = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				FrankensteinBrain.MoveTowardsRate = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				FrankensteinPet.decayminutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				GameModeSoftcore.reclaim_fraction_belt = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				GameModeSoftcore.reclaim_fraction_main = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				GameModeSoftcore.reclaim_fraction_wear = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				GrowableEntity.framebudgetms = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				HackableLockedCrate.decaySeconds = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				HackableLockedCrate.requiredHackSeconds = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				HalloweenDungeon.lifetime = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				HalloweenDungeon.population = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Horse.Population = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				HotAirBalloon.outsidedecayminutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				HotAirBalloon.population = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				HotAirBalloon.serviceCeiling = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				IOEntity.backtracking = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				IOEntity.debugBudgetThreshold = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				IOEntity.framebudgetms = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				IOEntity.responsetime = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				JunkPileWater.framebudgetms = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Megaphone.MegaphoneVoiceRange = str.ToFloat(0f);
			},
			Default = "100"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				MiniCopter.insidedecayminutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				MiniCopter.outsidedecayminutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				MiniCopter.population = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				MLRS.brokenDownMinutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ModularCar.outsidedecayminutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ModularCar.population = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				MotorRowboat.deepwaterdecayminutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				MotorRowboat.outsidedecayminutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				MotorRowboat.population = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				NPCAutoTurret.sleeperhostiledelay = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				PetBrain.ControlDistance = str.ToFloat(0f);
			},
			Default = "100"
		},
		new ConsoleSystem.Command
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				PetBrain.DrownTimer = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Polarbear.Population = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ReclaimManager.reclaim_expire_minutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RelationshipManager.forgetafterminutes = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RelationshipManager.maxplayerrelationships = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RelationshipManager.maxTeamSize = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RelationshipManager.mugshotUpdateInterval = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RelationshipManager.seendistance = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RHIB.rhibpopulation = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				RidableHorse.Population = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AiManager.ai_dormant_max_wakeup_per_tick = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AiManager.ai_htn_animal_tick_budget = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AiManager.ai_htn_player_junkpile_tick_budget = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AiManager.ai_htn_player_tick_budget = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AiManager.ai_to_player_distance_wakeup_range = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AiManager.nav_obstacles_carve_state = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				AiManager.pathfindingIterationsPerFrame = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CoverPointVolume.cover_point_sample_step_height = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				CoverPointVolume.cover_point_sample_step_size = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SamSite.staticrepairseconds = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SantaSleigh.altitudeAboveTerrain = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SantaSleigh.desiredAltitude = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				ScrapTransportHelicopter.population = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SimpleShark.forceSurfaceAmount = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				SlotMachine.ForcePayoutIndex = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Snowmobile.outsideDecayMinutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Stag.Population = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TelephoneManager.MaxCallLength = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TelephoneManager.MaxConcurrentCalls = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TrainCar.decayminutes = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TrainCar.population = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TrainCar.wagons_per_engine = str.ToInt(0);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TrainCarUnloadable.decayminutesafterunload = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				TrainCouplingController.max_couple_speed = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Wolf.Population = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				XmasDungeon.playerdetectrange = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				XmasDungeon.xmaslifetime = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				XmasDungeon.xmaspopulation = str.ToFloat(0f);
			}
		},
		new ConsoleSystem.Command
		{
		...
		new ConsoleSystem.Command
		{
			...
			SetOveride = delegate(string str)
			{
				Zombie.Population = str.ToFloat(0f);
			}
		}
	};
}
