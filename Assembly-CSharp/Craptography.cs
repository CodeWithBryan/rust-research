...
{
	// Token: 0x060036D8 RID: 14040 RVA: 0x00146488 File Offset: 0x00144688
	public static void XOR(uint seed, ArraySegment<byte> src, ref ArraySegment<byte> dst)
	{
		int num = Craptography.hash.Length;
		int num2 = (int)((ulong)seed % (ulong)((long)num));
		for (int i = 0; i < src.Count; i++)
		{
			dst.Array[dst.Offset + i] = (src.Array[src.Offset + i] ^ Craptography.hash[(num2 + i) % num]);
		}
