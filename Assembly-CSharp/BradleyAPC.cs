...
{
	// Token: 0x06000827 RID: 2087 RVA: 0x0004E4CC File Offset: 0x0004C6CC
	...
	// Token: 0x06000828 RID: 2088 RVA: 0x0004E50C File Offset: 0x0004C70C
	public bool HasPath()
	{
		return this.currentPath != null && this.currentPath.Count > 0;
	}

	// Token: 0x06000829 RID: 2089 RVA: 0x0004E526 File Offset: 0x0004C726
	...
	// Token: 0x0600082A RID: 2090 RVA: 0x0004E53A File Offset: 0x0004C73A
	public bool IndexValid(int index)
	{
		return this.HasPath() && index >= 0 && index < this.currentPath.Count;
	}

	// Token: 0x0600082B RID: 2091 RVA: 0x0004E55A File Offset: 0x0004C75A
	...
	// Token: 0x0600082C RID: 2092 RVA: 0x0004E576 File Offset: 0x0004C776
	...
	// Token: 0x0600082D RID: 2093 RVA: 0x0004E59D File Offset: 0x0004C79D
	public bool PathComplete()
	{
		return !this.HasPath() || (this.currentPathIndex == this.currentPath.Count - 1 && this.AtCurrentPathNode());
	}

	// Token: 0x0600082E RID: 2094 RVA: 0x0004E5C8 File Offset: 0x0004C7C8
	...
	// Token: 0x0600082F RID: 2095 RVA: 0x0004E620 File Offset: 0x0004C820
	...
	// Token: 0x06000830 RID: 2096 RVA: 0x0004E6A0 File Offset: 0x0004C8A0
	public Vector3 PathDirection(int index)
	{
		...
		if (this.pathLooping)
		{
			...
			b = this.currentPath[loopedIndex];
			a = this.currentPath[this.GetLoopedIndex(index)];
		}
		else
		{
			if (index - 1 < 0)
			...
			{
				b = this.currentPath[index - 1];
			}
			a = this.currentPath[index];
		}
		return (a - b).normalized;
	}

	// Token: 0x06000831 RID: 2097 RVA: 0x0004E758 File Offset: 0x0004C958
	...
	// Token: 0x06000832 RID: 2098 RVA: 0x0004E7D4 File Offset: 0x0004C9D4
	public void AdvancePathMovement()
	{
		...
		float a = Vector3.Distance(vector, this.currentPath[this.currentPathIndex]);
		float value = Vector3.Distance(base.transform.position, vector);
		float num = Mathf.InverseLerp(8f, 0f, value);
		vector += global::BradleyAPC.Direction2D(this.currentPath[this.currentPathIndex], vector) * Mathf.Min(a, num * 20f);
		this.SetDestination(vector);
	}

	// Token: 0x06000833 RID: 2099 RVA: 0x0004E898 File Offset: 0x0004CA98
	...
	// Token: 0x06000834 RID: 2100 RVA: 0x0004E96C File Offset: 0x0004CB6C
	...
	// Token: 0x06000835 RID: 2101 RVA: 0x0004E9F4 File Offset: 0x0004CBF4
	...
	// Token: 0x06000836 RID: 2102 RVA: 0x0004EA9C File Offset: 0x0004CC9C
	public void UpdateTargetList()
	{
		...
		foreach (global::BaseEntity baseEntity in list)
		{
			if (baseEntity is global::BasePlayer)
			{
				...
				if (!basePlayer.IsDead() && !(basePlayer is HumanNPC) && this.VisibilityTest(baseEntity))
				{
					bool flag = false;
	...
	// Token: 0x06000837 RID: 2103 RVA: 0x0004EC5C File Offset: 0x0004CE5C
	...
	// Token: 0x06000838 RID: 2104 RVA: 0x0004EC80 File Offset: 0x0004CE80
	...
	// Token: 0x06000839 RID: 2105 RVA: 0x0004ECB0 File Offset: 0x0004CEB0
	...
	// Token: 0x0600083A RID: 2106 RVA: 0x0004EE0C File Offset: 0x0004D00C
	...
	// Token: 0x0600083B RID: 2107 RVA: 0x0004EE90 File Offset: 0x0004D090
	...
	// Token: 0x0600083C RID: 2108 RVA: 0x0004EFB8 File Offset: 0x0004D1B8
	...
	// Token: 0x0600083D RID: 2109 RVA: 0x0004F144 File Offset: 0x0004D344
	...
	// Token: 0x0600083E RID: 2110 RVA: 0x0004F278 File Offset: 0x0004D478
	private void ApplyDamage(BaseCombatEntity entity, Vector3 point, Vector3 normal)
	{
		float damageAmount = this.bulletDamage * UnityEngine.Random.Range(0.9f, 1.1f);
	...
	// Token: 0x0600083F RID: 2111 RVA: 0x0004F2EC File Offset: 0x0004D4EC
	...
	// Token: 0x06000840 RID: 2112 RVA: 0x0004F3F0 File Offset: 0x0004D5F0
	...
	// Token: 0x06000841 RID: 2113 RVA: 0x0004F508 File Offset: 0x0004D708
	...
	// Token: 0x06000842 RID: 2114 RVA: 0x0004F5A0 File Offset: 0x0004D7A0
	...
	// Token: 0x06000843 RID: 2115 RVA: 0x0004F63A File Offset: 0x0004D83A
	public void SetDestination(Vector3 dest)
	{
		this.destination = dest;
	}

	// Token: 0x06000844 RID: 2116 RVA: 0x0004F644 File Offset: 0x0004D844
	...
	// Token: 0x06000845 RID: 2117 RVA: 0x000059DD File Offset: 0x00003BDD
	public override void OnCollision(Collision collision, global::BaseEntity hitEntity)
	{
	}

	// Token: 0x06000846 RID: 2118 RVA: 0x0004F695 File Offset: 0x0004D895
	...
	// Token: 0x06000847 RID: 2119 RVA: 0x0004F6D0 File Offset: 0x0004D8D0
	...
	// Token: 0x06000848 RID: 2120 RVA: 0x0004F760 File Offset: 0x0004D960
	...
	// (get) Token: 0x06000849 RID: 2121 RVA: 0x000292BC File Offset: 0x000274BC
	...
	// Token: 0x0600084A RID: 2122 RVA: 0x0004F7A6 File Offset: 0x0004D9A6
	public bool IsAtDestination()
	{
		return Vector3Ex.Distance2D(base.transform.position, this.destination) <= this.stoppingDist;
	}

	// Token: 0x0600084B RID: 2123 RVA: 0x0004F7C9 File Offset: 0x0004D9C9
	...
	// Token: 0x0600084C RID: 2124 RVA: 0x0004F7EC File Offset: 0x0004D9EC
	...
	// Token: 0x0600084D RID: 2125 RVA: 0x0004F840 File Offset: 0x0004DA40
	...
	// Token: 0x0600084E RID: 2126 RVA: 0x0004F9B2 File Offset: 0x0004DBB2
	...
	// Token: 0x0600084F RID: 2127 RVA: 0x0004F9D0 File Offset: 0x0004DBD0
	public void UpdateMovement_Patrol()
	{
		...
		if (Vector3.Distance(this.finalDestination, closestToPoint.transform.position) > 2f)
		{
			...
			Stack<BasePathNode> stack;
			float num;
			if (AStarPath.FindPath(basePathNode, closestToPoint, out stack, out num))
			{
				this.currentPath.Clear();
				if (flag)
				{
				...
				foreach (BasePathNode basePathNode2 in stack)
				{
	...
	// Token: 0x06000850 RID: 2128 RVA: 0x0004FBC4 File Offset: 0x0004DDC4
	public void UpdateMovement_Hunt()
	{
		...
		if (targetInfo.IsValid())
		{
			...
			{
				bool flag = false;
				BasePathNode start = this.patrolPath.GetClosestToPoint(base.transform.position);
				List<BasePathNode> list = Facepunch.Pool.GetList<BasePathNode>();
				if (this.GetEngagementPath(ref list))
				{
					flag = true;
				...
				BasePathNode basePathNode = null;
				List<BasePathNode> list2 = Facepunch.Pool.GetList<BasePathNode>();
				...
				foreach (BasePathNode basePathNode2 in list2)
				{
					Stack<BasePathNode> stack2 = new Stack<BasePathNode>();
					float num2;
					if (targetInfo.entity.IsVisible(basePathNode2.transform.position + new Vector3(0f, y, 0f), float.PositiveInfinity) && AStarPath.FindPath(start, basePathNode2, out stack2, out num2) && num2 < num)
					{
						stack = stack2;
						num = num2;
						basePathNode = basePathNode2;
				...
				{
					Stack<BasePathNode> stack3 = new Stack<BasePathNode>();
					BasePathNode basePathNode3 = list2[UnityEngine.Random.Range(0, list2.Count)];
					float num3;
					if (AStarPath.FindPath(start, basePathNode3, out stack3, out num3) && num3 < num)
					{
						stack = stack3;
						basePathNode = basePathNode3;
					}
				}
				if (stack != null)
				{
					...
					foreach (BasePathNode basePathNode4 in stack)
					{
						this.currentPath.Add(basePathNode4.transform.position);
					}
					this.currentPathIndex = -1;
					this.pathLooping = false;
					this.finalDestination = basePathNode.transform.position;
				}
				Facepunch.Pool.FreeList<BasePathNode>(ref list2);
	...
	// Token: 0x06000851 RID: 2129 RVA: 0x0004FEA8 File Offset: 0x0004E0A8
	public void DoSimpleAI()
	{
		...
		float value = Vector3.Distance(base.transform.position, this.finalDestination);
		if (num > this.stoppingDist)
		{
			Vector3 lhs = global::BradleyAPC.Direction2D(this.destination, base.transform.position);
			...
			{
				this.turning = Mathf.Clamp(num2 * 3f, -1f, 1f);
			}
			float num5 = 1f - Mathf.InverseLerp(0f, 0.3f, Mathf.Abs(this.turning));
			float num6 = Mathf.InverseLerp(0.1f, 0.4f, Vector3.Dot(base.transform.forward, Vector3.up));
			this.throttle = (0.1f + Mathf.InverseLerp(0f, 20f, value) * 1f) * num5 + num6;
		}
		this.DoWeaponAiming();
		base.SendNetworkUpdate(global::BasePlayer.NetworkQueue.Update);
	}

	// Token: 0x06000852 RID: 2130 RVA: 0x000500AA File Offset: 0x0004E2AA
	...
	// Token: 0x06000853 RID: 2131 RVA: 0x000500C4 File Offset: 0x0004E2C4
	public void DoPhysicsMove()
	{
		...
		if (num < 20f)
		{
			float value = Vector3.Dot(this.PathDirection(this.currentPathIndex), this.PathDirection(this.currentPathIndex + 1));
		...
		{
			float num5 = num2;
			foreach (PathSpeedZone pathSpeedZone in this.patrolPath.speedZones)
			{
			...
			this.currentSpeedZoneLimit = Mathf.Lerp(this.currentSpeedZoneLimit, num5, UnityEngine.Time.deltaTime);
		...
		this.leftThrottle = Mathf.Clamp(this.leftThrottle + num6, -1f, 1f);
		this.rightThrottle = Mathf.Clamp(this.rightThrottle + num6, -1f, 1f);
		...
		this.ScaleSidewaysFriction(1f - num7);
	...
	// Token: 0x06000854 RID: 2132 RVA: 0x0005044C File Offset: 0x0004E64C
	...
	// Token: 0x06000855 RID: 2133 RVA: 0x00050460 File Offset: 0x0004E660
	...
	// Token: 0x06000856 RID: 2134 RVA: 0x000504B0 File Offset: 0x0004E6B0
	...
	// Token: 0x06000857 RID: 2135 RVA: 0x00050528 File Offset: 0x0004E728
	...
	// Token: 0x06000858 RID: 2136 RVA: 0x000505F8 File Offset: 0x0004E7F8
	...
	// Token: 0x06000859 RID: 2137 RVA: 0x00050635 File Offset: 0x0004E835
	...
	// Token: 0x0600085A RID: 2138 RVA: 0x00050674 File Offset: 0x0004E874
	...
	// Token: 0x0600085B RID: 2139 RVA: 0x00050A5C File Offset: 0x0004EC5C
	...
	// Token: 0x0600085C RID: 2140 RVA: 0x00050AA0 File Offset: 0x0004ECA0
	...
	// Token: 0x0600085D RID: 2141 RVA: 0x00050AF8 File Offset: 0x0004ECF8
	...
	{
		// Token: 0x06004AC0 RID: 19136 RVA: 0x00190BF1 File Offset: 0x0018EDF1
		...
		// Token: 0x06004AC1 RID: 19137 RVA: 0x00190C10 File Offset: 0x0018EE10
		...
		// Token: 0x06004AC2 RID: 19138 RVA: 0x000059DD File Offset: 0x00003BDD
		public void LeavePool()
		{
		}

		// Token: 0x06004AC3 RID: 19139 RVA: 0x00190C20 File Offset: 0x0018EE20
		...
		// Token: 0x06004AC4 RID: 19140 RVA: 0x00190D07 File Offset: 0x0018EF07
		public bool IsVisible()
		{
			return this.lastSeenTime != -1f && UnityEngine.Time.time - this.lastSeenTime < global::BradleyAPC.sightUpdateRate * 2f;
		}

		// Token: 0x06004AC5 RID: 19141 RVA: 0x00190D31 File Offset: 0x0018EF31
		public bool IsValid()
		{
